defmodule StreetBiteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StreetBiteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StreetBiteWeb.Gettext, "errors", msg, opts)
    end
  end
